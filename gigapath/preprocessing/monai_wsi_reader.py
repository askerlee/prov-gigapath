# NOTE: This is a patched version of the original monai/data/wsi_reader.py file.
# Overwrite MONAI's site-packages/monai/data/wsi_reader.py to apply the patch.
# Added support of "tiffslide" backend (in the disguise of "openslide").
...
USE_TIFFSLIDE = True
if USE_TIFFSLIDE:
    OpenSlide, _ = optional_import("tiffslide", name="TiffSlide")
else:
...
@require_pkg(pkg_name="tiffslide")
